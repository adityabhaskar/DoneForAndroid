...
public class DoneListProvider extends ContentProvider {
    ...
    * */
    static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, DoneListContract.PATH_TAGS, TAGS);
    ...
    public String getType(Uri uri) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case TAGS:
                return DoneListContract.TagEntry.CONTENT_TYPE;
            default:
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case TAGS: {
                retCursor = mOpenHelper.getReadableDatabase().query(
                        DoneListContract.TagEntry.TABLE_NAME,
                        projection,
                        selection,
                        selectionArgs,
                        null,
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case TAGS: {
                long _id = db.insert(DoneListContract.TagEntry.TABLE_NAME, null, values);
                if (_id > -1) // based on http://stackoverflow.com/a/17628179/1078008
                    returnUri = DoneListContract.TagEntry.buildTagUri(_id);
                else
                    throw new android.database.SQLException("Failed to insert row into " + uri);
                break;
            }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case TAGS:
                rowsDeleted = db.delete(
                        DoneListContract.TagEntry.TABLE_NAME, selection, selectionArgs);
                break;
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case TAGS:
                rowsUpdated = db.update(
                        DoneListContract.TagEntry.TABLE_NAME, values, selection, selectionArgs);
                break;
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case TAGS:
                tableName = DoneListContract.TagEntry.TABLE_NAME;
                break;
